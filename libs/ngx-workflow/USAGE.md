# Usage Guide for ngx-workflow

This guide provides examples on how to integrate and use the `ngx-workflow` library in your Angular components.
...
import { DiagramComponent, DiagramStateService, Node, Edge } from 'ngx-workflow'; // Import from ngx-workflow
